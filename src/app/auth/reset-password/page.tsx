        ...
        <div className="mx-auto w-full max-w-90">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1">
              <label className="text-[11px] font-semibold text-zinc-300 uppercase tracking-wider">New Password</label>
              ...
              <p className="text-[10px] text-zinc-400 mt-1">Must be at least 8 characters.</p>
            </div>

            {/* Confirm New Password */}
            <div className="space-y-1">
              <label className="text-[11px] font-semibold text-zinc-300 uppercase tracking-wider">Confirm Password</label>
              <div className="relative">
                <Input 
            ...
            <Button className="w-full h-11 rounded-xl bg-[#009E49]/90 hover:bg-[#009E49] backdrop-blur-md text-white font-extrabold text-base mt-6 shadow-[0_0_15px_rgba(0,158,73,0.3)] border border-[#009E49]/50 transition-all hover:scale-[1.02]">
              Reset Password
            </Button>
          </form>
        </div>
